...
export default function CarryBagsPage() {
  return (
      ...
      <main className="flex-grow">
        ...
        <PageHeader
          ...
          breadcrumb={[
            ...
            { title: "Carry Bags", href: "/products/bags" },
          ]}
        />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  A stylish, sustainable bag handcrafted from banana fiber—perfect for everyday errands with eco-friendly
                  flair. Lightweight yet durable, it’s an ideal choice for conscious consumers.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Eco-Conscious Design</h3>
                      <p className="text-gray-600">
                        Crafted from renewable banana fiber, reducing reliance on synthetic materials.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Versatile Use</h3>
                      <p className="text-gray-600">
                        Spacious enough for groceries, books, or daily essentials, with sturdy handles.
                      </p>
                    </div>
                  </div>
                </div>
                <p className="text-[#28a745] font-bold text-xl mt-6">Price: RWF 8,000</p>
